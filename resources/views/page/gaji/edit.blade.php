                                ...
                                <form action="{{ route('gaji.update', $data->id) }}" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="id_karyawan" id="id_karyawan" class="form-control" required>
                                            ...
                                            @foreach ($karyawan as $k)
                                                <option value="{{ $k->id }}"
                                                    {{ $data->id_karyawan == $k->id ? 'selected' : '' }}>
                                                    {{ $k->nama }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="jabatan" class="form-control"
                                            value="{{ $data->karyawan->jabatan->nama ?? '' }}" readonly>
                                    </div>
                                    <div class="form-group">
                                        <label>Gaji Pokok</label>
                                        <input type="number" name="gaji_pokok" id="gaji_pokok" class="form-control"
                                            value="{{ $data->gaji_pokok }}" min="0" required>
                                    </div>
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="persen_pajak" id="persen_pajak"
                                                    class="form-control" value="{{ $data->persen_pajak }}" min="0"
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="persen_bpjs" id="persen_bpjs"
                                                    class="form-control" value="{{ $data->persen_bpjs }}" min="0"
                                                    max="100" step="0.01" readonly>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input type="month" name="bulan_absensi" id="bulan_absensi"
                                                    class="form-control"
                                                    value="{{ \Carbon\Carbon::parse($data->tgl_gaji)->format('Y-m') }}">
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="total_jam_lembur" id="total_jam_lembur"
                                                    class="form-control" value="{{ $data->total_jam_lembur }}" min="0"
                                                    readonly>
                                            </div>
                                        </div>
                                        <div class="col-4">
